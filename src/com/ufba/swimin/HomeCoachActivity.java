...
public class HomeCoachActivity extends Activity {
	...
	/* ---------------------------------------------------------------------
	 * Carrega os dados da tela - texto de boas-vindas e �ltimos treinos
	 */
	...
	public void carregaDadosNaTela(){
		...
		// Recupera os dados do �ltimo treino
		if(buscarDados("treinos", new String[]{"id_atleta","tipo_nado", "metros",
			...
			// Recupera os dados do pen�ltimo treino
			...
			/*Alguns textos ficar�o provisoriamente invis�veis, 
	...
	public void abreOuCriaBanco() {
		try{
			...
			//C�digo usado pra limpar as tabelas, quando necess�rio
			//limparTabelas();
	...
	public void gravarRegistro(){
		try{
			if(!buscarDados("pessoas", new String[]{"id"})){
				//O aplicativo � executado pela primeira vez
			...
			/*String sql = "INSERT INTO pessoas (nome, data_nasc, endereco) values "
					...
					//+ "('Thalita Andrade', '09/11/1988', 'Rua Itamb�m Ticotico - Salvador BA')";
					//+ "('Helder Carvalho', '11/12/1995', 'Rua Circo Pegafogo - Salvador BA')";
					//+ "('Lucas Augusto', '30/03/1956', 'Rua Vandr� Datena - S�o Paulo SP')";
			bancoDados.execSQL(sql);
			...
			bancoDados.execSQL(sql);
			sql = "INSERT INTO pessoas (nome, data_nasc, endereco) values "
					+ "('Caio Jos�', '30/01/1980', 'Rua Manoel Tavares - Salvador BA')";
			bancoDados.execSQL(sql);
			sql = "INSERT INTO atletas (id, peso, altura) values "
					+ "(5, 60.6, 1.68)";
			bancoDados.execSQL(sql);
